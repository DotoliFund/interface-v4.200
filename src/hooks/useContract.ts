...
export function useXXXFund2Contract(withSignerIfPossible?: boolean): XXXFund2 | null {
  return useContract<XXXFund2>(XXXFUND2_ADDRESSES, XXXFund2ABI, withSignerIfPossible)
}
