...
import InvestorCurrencyList from './CurrencyList/InvestorCurrecyList'
...
interface AllWhiteListFundCurrencyListProps {
  isOpen: boolean
...
export function AllWhiteListFundCurrencyList({
  isOpen,
  showWrappedETH,
  onDismiss,
  selectedCurrency,
